                                           ...
                                           plasma_complex64_t *pB, int ldb)
{
    ...
    // Call StarPU tile async function
    plasma_starpu_ztrsm(side, uplo, transa, diag,
                         alpha, A,
                                B,
                         &sequence, &request);

    // Translate back to LAPACK layout.
    plasma_starpu_zdesc2ge(B, pB, ldb, &sequence, &request);
 ...
 *
 * @sa plasma_ztrsm
 * @sa plasma_starpu_ctrsm
 * @sa plasma_starpu_dtrsm
 * @sa plasma_starpu_strsm
 *
 ******************************************************************************/
