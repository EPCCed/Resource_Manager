                  ...
                  plasma_complex64_t *pA, int lda)
{
    ...
    plasma_starpu_ztr2desc(pA, lda, A, &sequence, &request);

    // Call the tile async function.
    plasma_starpu_zpotrf(uplo, A, &sequence, &request);

    // Translate back to LAPACK layout.
    plasma_starpu_zdesc2tr(A, pA, lda, &sequence, &request);
 ...
 * @sa plasma_zpotrf
 * @sa plasma_starpu_zpotrf
 * @sa plasma_starpu_cpotrf
 * @sa plasma_starpu_dpotrf
 * @sa plasma_starpu_spotrf
 *
 ******************************************************************************/
