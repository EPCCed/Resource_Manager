...
static void core_starpu_cpu_zttmqr(void *descr[], void *cl_arg)
{
...
/******************************************************************************/
// StarPU codelet.
struct starpu_codelet core_starpu_codelet_zttmqr = {
    .cpu_func  = core_starpu_cpu_zttmqr,
    .nbuffers  = 4,
    .name      = "zttmqr"
};
