...
//        plasma_tune_geqrf(plasma, PlasmaComplexDouble, m, n);
    ...
    plasma_ompss_zgeqrf(A, *T, work, &sequence, &request);

    // synchronization
    #pragma oss taskwait

    // Translate back to LAPACK layout.
    plasma_ompss_zdesc2ge(A, pA, lda, &sequence, &request);
 ...
 *
 * @sa plasma_zgeqrf
 * @sa plasma_ompss_cgeqrf
 * @sa plasma_ompss_dgeqrf
 * @sa plasma_ompss_sgeqrf
 *
 ******************************************************************************/
