...
//        plasma_tune_potrf(plasma, PlasmaComplexDouble, n);
    ...
    plasma_ompss_ztr2desc(pA, lda, A, &sequence, &request);

    // synchronization
    //#pragma oss taskwait

    // Call the tile async function.
    plasma_ompss_zpotrf(uplo, A, &sequence, &request);

    // synchronization
    //#pragma oss taskwait

    // Translate back to LAPACK layout.
    plasma_ompss_zdesc2tr(A, pA, lda, &sequence, &request);
 ...
 * @sa plasma_zpotrf
 * @sa plasma_ompss_zpotrf
 * @sa plasma_ompss_cpotrf
 * @sa plasma_ompss_dpotrf
 * @sa plasma_ompss_spotrf
 *
 ******************************************************************************/
